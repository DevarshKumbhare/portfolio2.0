    ...
    <section id="project" className="max-w-container mx-auto lgl:px-20 py-24">
      ...
      <div className="w-full flex flex-col items-center justify-center gap-28 mt-10">
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          <a
            className="w-full xl:w-1/2 h-auto relative group"
            href="https://react-chat-app-2bc7f.web.app/"
            target="_blank"
          >
            <div>
              <Image
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-textGreen duration-300"
                href="https://github.com/DevarshKumbhare/firebase-chat"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10">
            ...
            An innovative web scraping and conversational question-answering application.
            The application leverages <span className="text-textGreen">web scraping techniques, Langchain, GPT-3.5 </span>
            to extract information from websites and provide answers to 
            various questions regarding the website{" "}
            </p>
            <ul className="text-xs md:text-sm font-titleFont tracking-wide flex gap-2 md:gap-5 justify-between text-textDark">
              <li>Python</li>
              <li>Web Scraping</li>
